...
export default function CreateTaskScreen() {
  ...
  const Task_Type = ['Standalone Task', 'Project Task', 'Form Inspection'];
  ...
  const handleSubmit = async () => {
    ...
    if (
      ...
      Alert.alert(
        'Validation Error',
        'Please select a Project for Project Task',
      );
      return;
    }

    if (
      selectedTaskType === 'Form Inspection' &&
      !selectedInspectionId &&
      !selectedInspection
    ) {
      Alert.alert(
        'Validation Error',
        'Please select an Inspection for Form Inspection',
      );
      return;
    }
    ...
    if (!hasAssignment) {
      Alert.alert(
        'Validation Error',
        'Please select at least one Assignment Location (Department, Zone, Circle, Division, Sub-Division, Designation or User)',
      );
      return;
    }
    ...
    try {
      ...
      if (selectedProjectId) {
        ...
        console.warn(
          'Project selected without id; consider selecting project from list to get id',
        );
      }
      ...
      if (selectedDesignationId)
        payload.designation_id = Number(selectedDesignationId);
      if (selectedDepartmentId)
        payload.assign_department_id = Number(selectedDepartmentId);
      ...
      if (selectedDivisionId)
        payload.assign_division_id = Number(selectedDivisionId);
      if (selectedSubDivisionId)
        payload.assign_sub_division_id = Number(selectedSubDivisionId);
            ...
            <View style={styles.section}>
              ...
              <TouchableOpacity
                style={[
                  styles.dropdown,
                  {
                    opacity: params?.returnTab === 'project' ? 0.4 : 1,
                  },
                ]}
                disabled={params?.returnTab === 'project' ? true : false}
                ...
                <TouchableOpacity
                  ...
                  <Text
                    style={[
                      ...
                      !(selectedTaskType === 'Project Task'
                        ? selectedProject
                        : selectedInspection) && styles.placeholderText,
                    ]}>
                    {(selectedTaskType === 'Project Task'
                      ? selectedProject
                      : selectedInspection) ||
          ...
          <View style={styles.card}>
            ...
            <TouchableOpacity
              ...
              <Text
                style={[
                  styles.dropdownTriggerText,
                  !selectedCircle && styles.placeholderText,
                ]}>
            ...
            <TouchableOpacity
              ...
              <Text
                style={[
                  styles.dropdownTriggerText,
                  !selectedDivision && styles.placeholderText,
                ]}>
            ...
            <TouchableOpacity
              ...
              <Text
                style={[
                  styles.dropdownTriggerText,
                  !selectedSubDivision && styles.placeholderText,
                ]}>
            ...
            <TouchableOpacity
              ...
              <Text
                style={[
                  styles.dropdownTriggerText,
                  !selectedDesignation && styles.placeholderText,
                ]}>
