...
with_node \
  ...
  --target "/Users/spxmac032/Documents/ReactNativeProject/govtrack/ios/Pods/Target Support Files/Pods-PWDDelhiApp/ExpoModulesProvider.swift" \
  --entitlement "/Users/spxmac032/Documents/ReactNativeProject/govtrack/ios/PWDDelhiApp/PWDDelhiApp.entitlements" \
   \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-av" "expo-blur" "expo-clipboard" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-document-picker" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-image-picker" "expo-keep-awake" "expo-linking" "expo-location" "expo-notifications" "expo-router" "expo-secure-store" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
